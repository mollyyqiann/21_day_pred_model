...
**Encoded rules.** Entry: top-5 by `raw_margin`, first appearance of that ticker only, extension indicator FAVOURABLE (0 of 3 flags), free slot. Exit: +12% take profit, or out of the top-15 for 2 consecutive publication days, or 21 trading days. Sizing: 8 equal slots, fractional dollar orders.
